...
if __name__ == "__main__":
    ...
    print("Putting (1, 'one'):", map.put(1, "one"))
    print("Replacing (1, 'two'):", map.replace(1, "two"))
    print("Removing (1, 'two)", map.remove(1))
    print("Setting (1, 'three')", map.set(1, "three"))
    print("Getting (1, 'three')", map.get(1))
    print("Size:", map.size)
    print("Putting (2, 'two')", map.put(2, "two"))
